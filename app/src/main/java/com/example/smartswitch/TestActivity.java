...
public class TestActivity extends AppCompatActivity {
    ...
    private class ConnectThread implements Runnable {
        ...
        ConnectThread(String ip, int port) {
            ...
            mConnectionStatus.setText("connecting to " + serverIP + ":" + serverPort + ".......");
        }
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (isConnected) {
                        ...
                        mConnectionStatus.setText("connected to " + serverIP + ":" + serverPort);

                        mReceiverThread = new Thread(new ReceiverThread());
                        mReceiverThread.start();
                    }else{

                        Log.d(TAG, "failed to connect to server " + serverIP + ":" + serverPort);
                        mConnectionStatus.setText("failed to connect to server "  + serverIP + ":" + serverPort);
                    }
